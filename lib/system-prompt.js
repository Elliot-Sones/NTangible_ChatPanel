...
function generateVisualizations({ playerData, mentionedPlayers, visiblePlayers, viewContext, assistantMessage, userMessage }) {
  ...
  // 1. Comparison Table — 2+ mentioned players (or compare keyword with players)
  const compareKeywords = ['compare', 'comparison', 'head-to-head', 'vs', 'versus', 'options', 'best'];
  ...
  if (mentionedPlayers && tablePlayerCount >= 2 && (tablePlayerCount <= 3 || wantsCompare)) {
