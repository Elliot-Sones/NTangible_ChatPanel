...
- ARCHETYPE: Derived from Clutch Factor + Fit Score combination:
  ...
  * Low Clutch (<750) + Low Fit (<62.5%) = At Risk`,
  ...
  // ===== GUARDRAILS & COMPLIANCE (5 chunks) =====
  {
    category: 'guardrails',
    subcategory: 'Legal',
    title: 'No Definitive Directives',
    content: `The chatbot must never explicitly tell a coach who to recruit, cut, or play. All advice must be framed as "suggestions," "probabilities," or "data points to consider." This guardrail protects NTangible from liability by ensuring coaches retain full decision-making authority.`,
    metadata: {}
  },
  {
    category: 'guardrails',
    subcategory: 'Legal',
    title: 'The Sole Determinant Firewall (Title VII & EEOC)',
    content: `NTangible assessments must never be used as the sole dispositive factor for recruitment, hiring, scholarships, or roster selection. Coaches are solely responsible for ensuring their use of the data complies with employment and non-discrimination laws, including Title VII and EEOC guidelines, and they agree to indemnify NTangible against such claims. If a coach attempts to use NTangible scores as a legal defense for cutting or not recruiting a player, the response must clearly state that this is not an appropriate use of the data.`,
    metadata: {}
  },
  {
    category: 'guardrails',
    subcategory: 'Clinical',
    title: 'Non-Clinical Boundary (Crisis & Self-Harm)',
    content: `NTangible evaluates game-processing, not clinical mental health. As explicitly stated in Section 8 of the Terms of Use, the system does not monitor for medical emergencies, crisis situations, or immediate threats of self-harm. If a coach suspects distress, the chatbot must emphatically direct them to utilize their organization's own medical and crisis intervention protocols immediately. Never provide clinical advice, diagnoses, or mental health assessments.`,
    metadata: {}
  },
  {
    category: 'guardrails',
    subcategory: 'Legal',
    title: 'No Guaranteed Financial or NIL Outcomes',
    content: `When discussing scholarships or NIL valuations, the bot must clarify that while high-scoring athletes are statistically more reliable, the metric represents an observed correlation and performance probability, not a guaranteed financial return or outcome. Never promise or imply that a high Clutch Factor score guarantees scholarship offers, NIL deals, or financial success.`,
    metadata: {}
  },
  {
    category: 'guardrails',
    subcategory: 'Methodology',
    title: 'Contextualize Cognitive Scores with Physical Tools',
    content: `Cognitive scores are only one piece of the analytic picture and must be cross-referenced with traditional physical evaluations (e.g., a 20-80 scale). A low score represents a "cognitive development frontier" or "Physical/Mental Gap" — strictly not a character flaw. The Clutch Factor measures an athlete's "software" (the mind) as opposed to their "hardware" (the physical body). Always frame low scores as development opportunities, never as deficiencies.`,
    metadata: {}
  },

  // ===== OPERATIONAL METHODOLOGY (7 chunks) =====
  {
    category: 'operational',
    subcategory: 'Compliance',
    title: 'Age Limits and Assessment Compliance',
    content: `The minimum age for NTangible assessment is strictly 13 years old, ensuring compliance with worldwide data security laws and general reading comprehension levels. For users in U.S. K-12 settings, schools warrant they have obtained Prior Written Parental Consent under PPRA (Protection of Pupil Rights Amendment). No assessments may be administered to athletes under 13 under any circumstances.`,
    metadata: {}
  },
  {
    category: 'operational',
    subcategory: 'Testing',
    title: 'Testing Medium and Cadence',
    content: `The Clutch Factor is a 15-minute mobile test. It should be re-tested every six months to track longitudinal data and burnout. The NTerpret behavioral assessment is taken only once per year. Coaches should plan assessment windows at the start and midpoint of each season for optimal tracking.`,
    metadata: {}
  },
  {
    category: 'operational',
    ...
    content: `NTangible owns the underlying models and code, while the athlete owns their raw assessment data and grants NTangible a license to use it. NTangible operates on a consent-based sharing model. Coaches assume full legal liability for ensuring athlete consent and FERPA compliance when sharing data with scouts or media. All data sharing must go through proper consent channels.`,
    metadata: {}
  },
  {
    category: 'operational',
    subcategory: 'Data',
    title: 'Public vs Confidential Data Policy',
    content: `For high school athletes, NTangible may publicly highlight specific athletes and scores. At the collegiate and professional levels, all data is strictly confidential and used only in an aggregated, de-identified format. This distinction is critical for coaches to understand when discussing player data externally.`,
    metadata: {}
  },
  {
    category: 'operational',
    subcategory: 'Data',
    title: 'Transfer Portal Data Access',
    content: `If a player enters the transfer portal, their former coach retains access to their historical data because withdrawing consent does not retroactively invalidate prior disclosures. A new team recruiting the athlete must request data access directly from the player. If the test is older than six months, the new team must administer an updated assessment. The portal does not automatically transfer or revoke data access.`,
    metadata: {}
  },
  {
    category: 'operational',
    subcategory: 'System',
    title: 'Algorithmic Shifts and Score Changes',
    content: `Scores do not spontaneously change overnight. If a player's score changes unexpectedly, it means they retook the assessment after the six-month window. While NTangible may retrospectively apply algorithmic updates to improve validity, the system is probabilistic. Coaches should not be alarmed by minor score fluctuations between assessment periods.`,
    metadata: {}
  },
  {
    category: 'operational',
    subcategory: 'System',
    title: 'System Outages and Availability',
    content: `NTangible does not guarantee uninterrupted availability. However, unexpected outages during high-stakes windows (like National Signing Day) do not happen — any maintenance is planned, communicated via email, and executed during off-hours (e.g., midnight or 3:00 a.m.). NTangible is not liable for missed recruiting opportunities due to outages.`,
    metadata: {}
  },

  // ===== CLUTCH FACTOR - MASTER RUBRIC (1 chunk) =====
  {
    category: 'clutch',
    subcategory: 'Master Rubric',
    title: 'The 65/35 Rule and Official Clutch Factor Scoring',
    content: `The Clutch Factor (scale 0-1000) measures an athlete's "software" (the mind) as opposed to their "hardware" (the physical body).

THE 65/35 RULE: The Clutch Factor is approximately 65% innate trait (predisposed mental genetic limits) and 35% trainable skill. It is highly improbable for a "Developing" player to reach an "Elite" score, so coaches must focus on maximizing the trainable 35%.

WHAT WE MEASURE: Neurological ability to lower heart rate under stress, cognitive processing speed under pressure, and predictive on-field success. A dropping score serves as a leading indicator of burnout.

OFFICIAL SCORING RUBRIC:
800-1000 (Elite): Highest neurological stress response; processing speed increases under pressure. 73% of current NCAA athletes here earn All-American/All-Conference honors.
750-799 (Great): Above the statistical threshold for high-stakes success; highly reliable for D1 recruitment. High schoolers >750 are twice as likely to commit to a D1 program.
725-749 (Strong): Solid cognitive performer, handles pressure better than most.
651-724 (Average): Performs well in familiar scenarios but inconsistent in novel environments; requires targeted mental skills plans.
0-650 (Developing): Physical tools are far ahead of cognitive processing; requires heavy coaching interventions like pressure training.

ARCHETYPES:
The "Walk-On" / Overachiever: Less physically gifted athletes who score exceptionally high; they compensate for physical gaps with superior processing and emotional control.
The "Paper Tiger": High physical ability but low mental scores.
The Physical/Mental Gap: If a star starter has a low score, their physical skills are simply much further along than their mental skills.`,
    metadata: {}
  },

  // ===== Q&A - OPERATIONAL & LEGAL (6 chunks) =====
  {
    category: 'qa',
    subcategory: 'Legal',
    title: 'Q&A: Using NTangible Scores as Legal Defense for Cutting a Player',
    content: `QUESTION: A kid's parents are threatening to sue me for discrimination because I cut him. Can I use his 'Poor' Alignment score as my legal defense?
APPROVED ANSWER: Absolutely not. NTangible assessments must never be used as the sole dispositive factor for recruitment, hiring, scholarships, or roster selection. You are solely responsible for ensuring your use of the data complies with all applicable employment and non-discrimination laws, including Title VII and EEOC guidelines, and you have agreed to indemnify NTangible against such claims.`,
    metadata: { qaType: 'legal' }
  },
  {
    category: 'qa',
    subcategory: 'Clinical',
    title: 'Q&A: Player Showing Signs of Distress or Self-Harm',
    content: `QUESTION: My player's Clutch Factor dropped 200 points, his NGauge pulse is erratic, and he looks exhausted. Does your system think he is a danger to himself?
APPROVED ANSWER: NTangible does not measure clinical health. As strictly outlined in Section 8 of our Terms of Use, the system is automated and does not monitor for medical emergencies, crisis situations, or immediate threats of self-harm. You must immediately utilize your organization's own medical and crisis intervention protocols.`,
    metadata: { qaType: 'clinical' }
  },
  {
    category: 'qa',
    subcategory: 'Legal',
    title: 'Q&A: ADHD Dyslexia and Impact on Cognitive Processing Speed',
    content: `QUESTION: I am recruiting a player who has ADHD and dyslexia. Will this unfairly impact his Cognitive Processing Speed?
APPROVED ANSWER: NTangible's assessments provide insights based purely on game-processing data in high-leverage sports situations. The system evaluates "software" under pressure but does not measure clinical mental health or neurodivergence. These scores should be viewed exclusively through a sports-performance lens, not a clinical one.`,
    metadata: { qaType: 'legal' }
  },
  {
    category: 'qa',
    subcategory: 'Operational',
    title: 'Q&A: System Outage on National Signing Day',
    content: `QUESTION: It is National Signing Day. What happens if the NTangible dashboard goes down right before I need to run a final Fit Analysis?
APPROVED ANSWER: You do not need to worry about an unexpected outage during a critical recruitment window. Any system maintenance is strictly planned, communicated via email by the NTangible team, and intentionally scheduled during off-hours (such as midnight or 3:00 a.m.) to ensure uninterrupted access when you need it most. NTangible is not liable for consequences arising from unavailability.`,
    metadata: { qaType: 'operational' }
  },
  {
    category: 'qa',
    subcategory: 'Data',
    title: 'Q&A: Transfer Portal Data Access and New Coach Visibility',
    content: `QUESTION: My starting quarterback just entered the transfer portal. Do I lose access to his NTangible profile, and can his new coach see his scores?
APPROVED ANSWER: You will still have access to his historical data. While athletes have the right to manage their data sharing, entering the portal does not retroactively remove your access to assessments completed under your program. For the new coach to see his data, they must request access directly from the player. If the assessment is older than six months, the new team must administer an updated Clutch Factor test.`,
    metadata: { qaType: 'data' }
  },
  {
    category: 'qa',
    subcategory: 'Data',
    title: 'Q&A: Sharing Player Scores with Scouts or Media',
    content: `QUESTION: Can I share a player's Clutch Factor score and NTerpret profile with a pro scout or a media outlet?
APPROVED ANSWER: Yes, you are allowed to share profiles if you choose, but NTangible operates on a consent-based sharing model. You, as the coach, are strictly responsible for ensuring you have the necessary rights, athlete consent, and FERPA/legal compliance to distribute this information.`,
    metadata: { qaType: 'data' }
  },

  // ===== Q&A - RECRUITING & NIL (4 chunks) =====
  {
    category: 'qa',
    subcategory: 'Recruiting',
    title: 'Q&A: Allocating Scholarship and NIL Budget Between Two Recruits',
    content: `QUESTION: I have to decide how to allocate my remaining scholarship and NIL budget between two recruits with identical physical evaluations. Recruit A has a Clutch Factor of 780, while Recruit B has a 610. Who gets the offer?
APPROVED ANSWER: While the final financial decision is yours and must factor in a comprehensive physical evaluation, the data suggests Recruit A presents a statistically higher probability of high-stakes success. A score of 780 makes them highly reliable when the game is on the line. Recruit B's 610 indicates a "Physical/Mental Gap" requiring immediate intervention. In theory, the higher Clutch athlete could be worth more regarding NIL valuations because their profile indicates a higher likelihood of surviving your development system, but this is an observed correlation, not a guaranteed financial outcome.`,
    metadata: { qaType: 'recruiting' }
  },
  {
    category: 'qa',
    subcategory: 'Recruiting',
    title: 'Q&A: Recruit with Low Clutch Factor but Elite Physical Tools',
    content: `QUESTION: I have a recruit with incredible physical tools, but his Clutch Factor is a 610. Should I drop him from my recruiting board?
APPROVED ANSWER: Not necessarily. A score of 610 falls into the "Developing" range, indicating a "Physical/Mental Gap" where his hardware is elite, but his software requires patching. This is a development opportunity, not a character flaw. If you recruit him, your staff must prioritize pressure training and pre-performance routines.`,
    metadata: { qaType: 'recruiting' }
  },
  {
    category: 'qa',
    subcategory: 'Recruiting',
    title: 'Q&A: Can a Developing Player Reach Elite Clutch Score',
    content: `QUESTION: Can a player in the "Developing" tier (610 score) realistically train to reach an "Elite" 800+ score?
APPROVED ANSWER: While not impossible, it is highly improbable. The Clutch Factor is approximately 65% innate trait and 35% trainable skill. A developing player has a predisposed lower cognitive range, meaning your staff should focus on maximizing their trainable 35% rather than expecting them to reach the Elite tier.`,
    metadata: { qaType: 'recruiting' }
  },
  {
    category: 'qa',
    subcategory: 'Recruiting',
    title: 'Q&A: At Risk vs Trust Anchor for Final Roster Spot',
    content: `QUESTION: I need to decide between two recruits for my final roster spot. One has elite physical tools but is in the "At Risk" quadrant. The other is physically average but is a "Trust / Anchor." Who should I choose?
APPROVED ANSWER: The "At Risk" player presents the highest friction risk and greatest management demand. Conversely, the "Trust / Anchor" player is your most reliable asset; they perform under pressure and process the game like you do. If you recruit the "At Risk" player, your staff will need to immediately build an Individual Development Plan with measurable milestones.`,
    metadata: { qaType: 'recruiting' }
  },

  // ===== Q&A - COACHING & ALIGNMENT (7 chunks) =====
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Star Player Has Low Clutch Score Despite Good Stats',
    content: `QUESTION: Your test gave my star starting pitcher a low Clutch score, but he has great stats and rarely struggles. Is the data wrong?
APPROVED ANSWER: No, the data represents only one portion of the player's analytical picture. If a highly successful starter has a lower score, it simply means that their physical skills are much farther along than their mental skills. Conversely, it is common to see "Walk-On" athletes score exceptionally high because their mental skills must far outweigh their physical limitations just to join a roster. For your star pitcher, developing his mental 35% will make him even more dominant.`,
    metadata: { qaType: 'coaching' }
  },
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Culture Carrier Who Freezes Under Pressure',
    content: `QUESTION: One of my players works incredibly hard and buys into our culture, but completely freezes during high-pressure game situations. What is the plan for them?
APPROVED ANSWER: This player is a "Culture Carrier" (High Alignment, Low Clutch). Do not give up on them; they believe in your system. You should invest heavily in Mental Skills Training, utilizing pressure training and pre-performance routines. Additionally, pair them alongside your "Trust / Anchor" players in practice, as proximity to high-clutch performers accelerates development.`,
    metadata: { qaType: 'coaching' }
  },
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Talented Player Who Argues with Coach',
    content: `QUESTION: I have a highly talented player who always comes up big in games, but they constantly argue with me in practice. How do I handle them?
APPROVED ANSWER: This athlete falls into the "High Reward / High Maintenance" quadrant. You should not rely on cultural osmosis. Instead, define explicit non-negotiables, use highly direct communication detailing exactly what you want, and give them a structured role. Constrain their context so their clutch instincts can produce results without breaking your system.`,
    metadata: { qaType: 'coaching' }
  },
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Kinesthetic Learner Not Responding to Whiteboard',
    content: `QUESTION: I have a player who just stares blankly at me when I try to teach a new play on the whiteboard. He's a Kinesthetic learner. What should I do differently?
APPROVED ANSWER: Because your athlete is a Kinesthetic learner, they learn best by doing and need physical engagement to build muscle memory. Instead of keeping him at the whiteboard, minimize long lectures. Put him on the field and prioritize physical reps and walkthroughs so he can learn through trial, error, and physical feeling.`,
    metadata: { qaType: 'coaching' }
  },
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Supportive Communicator Shutting Down from Criticism',
    content: `QUESTION: One of my athletes always seems to shut down when I give her constructive criticism. Her communication style is 'Supportive.' How can I fix this?
APPROVED ANSWER: Athletes with a "Supportive" communication style prioritize emotional safety and harmony, and dislike harsh criticism. Start with the positive and use a warm tone. Validate her feelings before you make corrections, and explicitly emphasize that your feedback is meant to support her development.`,
    metadata: { qaType: 'coaching' }
  },
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Intrinsic Growth Player and Leaderboards',
    content: `QUESTION: I want to get my point guard more fired up for practice. His motivational anchor is 'Intrinsic Growth'. Should I put a leaderboard up?
APPROVED ANSWER: No, a leaderboard is best for an athlete with a "Competitive Edge" anchor. Because your point guard is driven by "Intrinsic Growth," he is motivated by self-improvement and mastering his craft. Track his individual progress metrics, focus on personal bests, and frame challenges as skill acquisition.`,
    metadata: { qaType: 'coaching' }
  },
  {
    category: 'qa',
    subcategory: 'Coaching',
    title: 'Q&A: Reserved Communicator Going Silent in Front of Team',
    content: `QUESTION: My center is a 'Reserved' communicator. Sometimes I ask him a question in front of the team and he just goes silent. Is he ignoring me?
APPROVED ANSWER: It is highly unlikely he is ignoring you. "Reserved" communicators process information internally and prioritize observation and reflection. Do not mistake his silence for disinterest. Give him time to process your questions before demanding an answer, and try to ask him specific, open-ended questions.`,
    metadata: { qaType: 'coaching' }
  },
];
